	...
	: frame(0), run(0), x0(19.0f), y0(0.0f), x1(0.0f), y1(23.0f), x2(14.0f), y2(-x0)
{
	...
	tex[0] = pvr_mem_malloc(WIDTH * HEIGHT * 2);
	tex[1] = pvr_mem_malloc(WIDTH * HEIGHT * 2);
	...
	pvr_sq_set32(tex[0], 0, WIDTH * HEIGHT * 2, PVR_DMA_VRAM64);
	pvr_sq_set32(tex[1], 0, WIDTH * HEIGHT * 2, PVR_DMA_VRAM64);
